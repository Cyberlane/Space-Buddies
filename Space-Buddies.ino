...
int a_minor[] = {tone_A,tone_a,tone_B,tone_b,tone_C,tone_c,tone_D,tone_d,tone_E,tone_e,tone_F,tone_f,tone_E,tone_e,tone_F,tone_f,tone_G,tone_g};
int e_minor[] = {tone_E,tone_e,tone_F1,tone_f1,tone_G,tone_g,tone_A,tone_a,tone_B,tone_b,tone_C,tone_c,tone_D,tone_d};
int b_minor[] = {tone_B,tone_b,tone_C1,tone_c1,tone_D,tone_d,tone_E,tone_e,tone_F1,tone_f1,tone_G,tone_g,tone_A,tone_a};
int f_sharp[] = {tone_F1,tone_f1,tone_Ab,tone_ab,tone_A,tone_a,tone_B,tone_b,tone_C1,tone_c1,tone_D,tone_d,tone_E,tone_e};
int c_sharp[] = {tone_C1,tone_c1,tone_Eb,tone_eb,tone_E,tone_e,tone_F1,tone_f1,tone_A,tone_a,tone_B,tone_b};
int g_sharp[] = {tone_Eb,tone_eb,tone_Bb,tone_bb,tone_B,tone_b,tone_C1,tone_c1,tone_Eb,tone_eb,tone_E,tone_e,tone_F1,tone_f1};
int e_flat[] = {tone_Eb,tone_eb,tone_F,tone_f,tone_F1,tone_f1,tone_Ab,tone_ab,tone_Bb,tone_bb,tone_C,tone_c,tone_F,tone_f};
int b_flat[] = {tone_Bb,tone_bb,tone_C,tone_c,tone_C1,tone_c1,tone_Eb,tone_eb,tone_F,tone_f,tone_F1,tone_f1,tone_Ab,tone_ab};
int f_minor[] = {tone_F,tone_f,tone_G,tone_g,tone_Ab,tone_ab,tone_Bb,tone_bb,tone_C,tone_c,tone_C1,tone_c1,tone_Eb,tone_eb};
int c_minor[] = {tone_C,tone_c,tone_D,tone_d,tone_Eb,tone_eb,tone_F,tone_f,tone_G,tone_g,tone_Ab,tone_ab,tone_Bb,tone_bb};
int g_minor[] = {tone_G,tone_g,tone_A,tone_a,tone_Bb,tone_bb,tone_C,tone_c,tone_D,tone_d,tone_Eb,tone_eb,tone_F,tone_f};
int d_minor[] = {tone_D,tone_d,tone_E,tone_e,tone_F,tone_f,tone_G,tone_g,tone_A,tone_a,tone_Bb,tone_bb,tone_C,tone_c};

int* scales[] = {a_minor,e_minor,b_minor,f_sharp,c_sharp,g_sharp,e_flat,b_flat,f_minor,c_minor,g_minor,d_minor};
